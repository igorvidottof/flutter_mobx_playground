...
mixin _$ListItemModel on _ListItemModelBase, Store {
  final _$titleAtom = Atom(name: '_ListItemModelBase.title');
  ...
  final _$checkAtom = Atom(name: '_ListItemModelBase.check');
  ...
  final _$_ListItemModelBaseActionController =
      ActionController(name: '_ListItemModelBase');

  @override
  void setTitle(String value) {
    final _$actionInfo = _$_ListItemModelBaseActionController.startAction(
        name: '_ListItemModelBase.setTitle');
    try {
  ...
  void setCheck(bool value) {
    final _$actionInfo = _$_ListItemModelBaseActionController.startAction(
        name: '_ListItemModelBase.setCheck');
    try {
